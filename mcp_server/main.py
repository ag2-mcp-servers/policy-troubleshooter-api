...
app = MCPProxy(
    ...
    version='v1',
    servers=[{'url': 'https://policytroubleshooter.googleapis.com/'}],
)
...
def policytroubleshooter_iam_troubleshoot(
    ...
    body: GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequest = None,
):
